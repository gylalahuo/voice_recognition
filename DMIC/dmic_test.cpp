...
//				USART_WriteBlocking(USART2, (uint8_t *)&dmic_buffer[0], AUDIO_SAMPLES_STEP_ALGO *2);
			 flag1=1;		
...
//				USART_WriteBlocking(USART2, (uint8_t *)&dmic_buffer[AUDIO_SAMPLES_STEP_ALGO], AUDIO_SAMPLES_STEP_ALGO *2);
